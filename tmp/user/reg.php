...
<div class='bd'>
<form class='form'>		
<div class='hdd'>免费注册</div>	
<div class="input input1"><input id='uid'  placeholder='账号:英文或数字'/></div>
...
<?php } ?>
<div class="submit"><a href="/?type=user&type2=login" class="a2">立即登录</a><a href="#" class="a1 login">免费注册</a><input type='submit' class='login' value='登陆' style='display:none;'/></div> 
...
$.post("/index.php",{api:"user",api2:"reg",un:$("#uid").val(),pw:$("#pw").val(),id:$("#id").val()},function(json){
